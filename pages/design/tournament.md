...
联赛系统建立在底层平台之上,用 Instance + 共识 + 预言机搭建带积分约束的 PvP / 创意比赛流程。
...
| 阶段 | 协作的层 |
| ---- | -------- |
| 创建大型赛事 | [治理层](./governance.md) — 需要多签确认 |
| 创建临时 MC 实例 | [HAL](./hal.md) — Room 类型 Instance |
| 自动采集比赛数据 | [预言机](./oracle.md) — 客观指标 |
| 结果上链 | [共识层](./consensus.md) — Raft 写入 |
